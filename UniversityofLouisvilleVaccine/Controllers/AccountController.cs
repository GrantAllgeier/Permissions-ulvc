...
{
    [Authorize(Roles = "Admin, Executive, Program Staff, ReturningPatient, Researcher")]
    public class AccountController : Controller
    {
        public AccountController()
            : this(new UserManager<ApplicationUser>(new UserStore<ApplicationUser>(new UniversityofLouisvilleVaccine.DataContexts.ApplicationDbContext())))
        {
        }
